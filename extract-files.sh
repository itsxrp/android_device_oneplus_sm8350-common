...
function blob_fixup() {
    case "${1}" in
        ...
        vendor/lib64/vendor.qti.hardware.camera.postproc@1.0-service-impl.so)
            ...
            ;;
        odm/lib/liblvimfs_wrapper.so|odm/lib64/libCOppLceTonemapAPI.so|odm/lib64/libaps_frame_registration.so|odm/lib64/libSuperRaw.so|odm/lib64/libYTCommon.so|vendor/lib64/libalsc.so)
